...
class ReindexerClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Reindexer\Grpc\SqlRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\ServerStreamingCall
     */
    public function ExecSql(\Reindexer\Grpc\SqlRequest $argument,
      $metadata = [], $options = []) {
        return $this->_serverStreamRequest('/reindexer.grpc.Reindexer/ExecSql',
        $argument,
    ...
    /**
     * @param \Reindexer\Grpc\DeleteMetaRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function DeleteMeta(\Reindexer\Grpc\DeleteMetaRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/reindexer.grpc.Reindexer/DeleteMeta',
        $argument,
        ['\Reindexer\Grpc\ErrorResponse', 'decode'],
        $metadata, $options);
    }
